...
const RelatedDoctors = ({speciality,docId}) => {
  ...
  <div className='flex flex-col items-center gap-4 my-14 text-gray-900 md:mx-10'>
        <h1 className='text-3xl font-medium'>Related Specialists</h1>
        <p className='sm:w-1/3 text-center text-sm'>Explore similar mental health specialists for your needs.</p>
